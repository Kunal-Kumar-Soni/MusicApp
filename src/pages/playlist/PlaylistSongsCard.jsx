...
function PlaylistSongsCard({
  ...
  const { setPlayMusicSongLists } = usePlayMusic();
  const toggleMenu = (e) => {
    e.stopPropagation();
    setMenuOpenIndex((prev) => (prev === index ? null : index));
  };

  const handleRemove = (playlist, song) => {
      ...
      <div className="flex items-center gap-4">
        <div
          onClick={(e) => {
            ...
            setPlayMusicSongLists(playlist.songs);
          }}
